 ...
 */
export function createPromiseHook<TRequest, TResponse, TQuery extends IQueryParams = IQueryParams>(link: string, method: Method): IHookCallback<TRequest, TResponse, TQuery> {
	/**
